...
project = 'twx.botapi'
copyright = '2018, Vince Castellano, Phillip Lopo'
...
latex_documents = [
  (master_doc, 'twx.botapi.tex', 'twx.botapi Documentation',
...
man_pages = [
    (master_doc, 'twx.botapi', 'twx.botapi Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'twx.botapi', 'twx.botapi Documentation',
   author, 'twx.botapi', 'One line description of project.',
   'Miscellaneous'),
]
